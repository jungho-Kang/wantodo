      ...
      <SettingsCard>
        ...
        {cloudSyncEnabled && (
          <>
            ...
            <Text style={{ color: AccentTeal, fontSize: 14, paddingHorizontal: 16, paddingVertical: 12 }}>Synced</Text>
          </>
        )}
      </SettingsCard>
      ...
      {!cloudSyncEnabled && (
        <SettingsCard>
          <Pressable
            ...
            style={{ margin: 16, height: 48, borderRadius: 8, backgroundColor: AccentTeal, alignItems: 'center', justifyContent: 'center' }}
          >
          ...
          <Pressable
            ...
            style={{ marginHorizontal: 16, marginBottom: 16, height: 48, borderRadius: 8, borderWidth: 1, borderColor: '#ccc', alignItems: 'center', justifyContent: 'center' }}
          >
